...
export default function ImageMouseTrail({
	...
	return (
		<section
			...
			ref={containerRef}
			className={cn(
				'hidden mx-auto md:w-9/12 md:h-[600px] md:grid md:place-items-center bg-grid-white/10 border-white/10 border-2 relative overflow-hidden rounded-lg',
				className
			)}>
			...
			<article className="relative z-50 mix-blend-difference">{children}</article>
		</section>
	);
}
